...
export type VehicleOption = { id: string; name: string; plateNumber: string; vehicleModel?: { manufacturer: string; name: string } | null };
export type CreateBookingInput = {
  vehicleId: string; stationId: string; slotId?: string; serviceBayId?: string;
  scheduledStart: string; scheduledEnd: string; replacementRequestId?: string; reason?: string;
};
...
export type BookingDetail = Booking & {
  ...
  transactions: Array<{ id: string; workflowStatus: string; status: string; invoice?: unknown; inspection?: unknown; stepHistory: Array<{ id: string; fromStatus?: string | null; toStatus: string; createdAt: string; data?: any }>; payments: unknown[] }>;
};
