...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-green-600 hover:bg-green-700 text-white focus:ring-green-500 shadow-sm shadow-green-100 dark:shadow-none',
    ...
    outline: 'border border-gray-300 dark:border-gray-600 hover:bg-gray-55 text-gray-700 dark:text-gray-200 focus:ring-green-500',
  };
