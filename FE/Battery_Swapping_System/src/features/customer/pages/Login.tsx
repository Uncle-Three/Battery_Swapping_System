...
import { BatteryCharging, User, Zap, ClipboardList, ShieldCheck, ArrowRight, Loader2, KeyRound } from 'lucide-react';
...
const DEMO_ACCOUNTS = [
  ...
  },
  {
    ...
    icon: Zap,
    color: 'blue',
    desc: 'Xác minh khách, thay pin, kiểm tra SoH & lập phiếu bảo trì',
