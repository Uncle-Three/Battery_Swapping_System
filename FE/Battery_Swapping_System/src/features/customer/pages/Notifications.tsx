...
const TYPE_LABELS: Record<string, string> = {
  ...
  BATTERY_WARNING: 'Cảnh báo pin',
  MANDATORY_REPLACEMENT: 'Thay pin bắt buộc',
  VEHICLE_TRANSFER: 'Chuyển quyền xe',
...
const TYPE_COLORS: Record<string, string> = {
  ...
  BATTERY_WARNING: 'bg-red-50 text-red-700 dark:bg-red-950/30 dark:text-red-300',
  MANDATORY_REPLACEMENT: 'bg-orange-50 text-orange-700 dark:bg-orange-950/30 dark:text-orange-300',
  VEHICLE_TRANSFER: 'bg-cyan-50 text-cyan-700 dark:bg-cyan-950/30 dark:text-cyan-300',
  ACCOUNT_RECOVERY: 'bg-amber-50 text-amber-700 dark:bg-amber-950/30 dark:text-amber-300',
