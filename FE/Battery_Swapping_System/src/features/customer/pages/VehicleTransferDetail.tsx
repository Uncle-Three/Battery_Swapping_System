...
import { DocumentUploader, TwoSideDocumentUploader, AdditionalDocumentsUploader } from "../../../components/vehicle-transfer/DocumentUploader";
            ...
            {needsMoreInfo && request.additionalInfoRequest && (
              <div className="rounded-2xl border border-orange-200 bg-orange-50/90 p-6 space-y-4 dark:border-orange-800 dark:bg-orange-950/30">
                ...
                <div className="border-t border-orange-200 dark:border-orange-800 pt-4 space-y-4">
                  ...
                  <TwoSideDocumentUploader label="Cà vẹt xe (2 mặt)" value={docs.registrationDocumentUrl} onChange={(url) => setDocs((d) => ({ ...d, registrationDocumentUrl: url }))} required />
                  <TwoSideDocumentUploader label="Giấy tờ tùy thân / CCCD (2 mặt)" value={docs.identityDocumentUrl} onChange={(url) => setDocs((d) => ({ ...d, identityDocumentUrl: url }))} required />
            ...
            <div className="app-panel p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  { label: "Giấy tờ tùy thân", url: request.identityDocumentUrl, required: true },
                  { label: "Hợp đồng mua bán", url: request.purchaseContractUrl, required: false },
                ].map((doc) => (
                  <DocumentPreviewCard
                    key={doc.label}
                    label={doc.label}
