  ...
  if (success) {
    return (
      <div className="flex min-h-[60vh] items-center justify-center px-4 py-6">
        <div className="max-w-md w-full app-panel p-8 text-center space-y-5 shadow-xl">
        ...
        <div className="app-panel p-6 sm:p-8 space-y-6">
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              ...
              <TwoSideDocumentUploader
                label="Giấy đăng ký xe (Cà vẹt xe - 2 mặt)"
                hint="Vui lòng đính kèm bản chụp 2 mặt (Mặt trước và Mặt sau) của Giấy đăng ký xe"
                value={docs.registrationDocumentUrl}
                onChange={(url) => setDocs((d) => ({ ...d, registrationDocumentUrl: url }))}
                required
              />
              <TwoSideDocumentUploader
                label="Giấy tờ tùy thân (CCCD / Hộ chiếu - 2 mặt)"
                hint="Vui lòng đính kèm bản chụp 2 mặt (Mặt trước và Mặt sau) của Căn cước công dân"
