...
import { AlertTriangle, ArrowRight, BarChart3, BatteryCharging, Boxes, CheckCircle2, ClipboardCheck, Gauge, ScanLine, ShieldCheck, Users, Wrench } from 'lucide-react';
...
const dashboards = {
  ...
  [UserRole.ADMIN]: {
    eyebrow: 'Quản trị nền tảng', title: 'Kiểm soát toàn bộ hệ thống', description: 'Quản lý quyền truy cập, mạng lưới trạm, cấu hình và hoạt động của toàn hệ thống.',
    action: { to: '/admin/audit-logs', label: 'Kiểm tra nhật ký', icon: Gauge },
    cards: [
      ...
      { to: '/admin/reports', title: 'Báo cáo toàn hệ thống', text: 'Theo dõi hoạt động, rủi ro và hiệu quả mạng lưới.', icon: BarChart3, tone: 'violet' },
    ],
  },
} as const;
