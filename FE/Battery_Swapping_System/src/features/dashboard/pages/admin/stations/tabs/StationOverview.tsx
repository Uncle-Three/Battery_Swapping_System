...
export const StationOverview: FC = () => {
  ...
  const cards = [
    ['Tổng khoang thay pin', data.totalBays, 'bays-slots', CalendarClock], ['Khoang sẵn sàng', data.availableBays, 'bays-slots', CheckCircle2], ['Khoang bảo trì', data.maintenanceBays, 'maintenance', ShieldAlert],
    ...
    ['Pin cần kiểm tra', data.inspectionBatteries, 'inventory', ShieldAlert], ['Pin đang bảo trì', data.maintenanceBatteries, 'maintenance', ShieldAlert], ['Nhân sự được phân công', data.assignedStaffCount, 'staff', Users],
  ] as const;
