        ...
        <div className="space-y-6">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="mt-4 flex flex-col gap-4 relative">
              ...
              )) : !item.cancellation && <p className="text-sm font-semibold text-slate-500 italic text-center py-4 bg-slate-50 dark:bg-slate-800/30 rounded-xl">Chưa có thao tác nào được ghi nhận.</p>}
              {item.cancellation && (
                <div className="relative pl-6">
                  <div className="absolute left-0 top-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-rose-100 ring-4 ring-white dark:bg-rose-900/50 dark:ring-slate-900">
                  ...
                  <p className="mt-1 text-xs font-bold text-rose-600">{new Date(item.cancellation.cancelledAt).toLocaleString('vi-VN')}</p>
                  <p className="mt-2 rounded-lg bg-rose-50 p-3 text-sm font-medium text-rose-800 dark:bg-rose-950/30 dark:text-rose-300">
