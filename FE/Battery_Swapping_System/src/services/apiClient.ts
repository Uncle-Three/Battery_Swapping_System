...
const apiMessageTranslations: Array<[RegExp, string]> = [
  ...
  [/^Account is not active\.?$/i, 'Tài khoản đã bị khóa hoặc chưa được kích hoạt.'],
  [/^Vehicle already has an active booking\.?$/i, 'Xe này đã có lịch thay pin đang xử lý. Vui lòng hoàn tất hoặc hủy lịch hiện tại trước.'],
