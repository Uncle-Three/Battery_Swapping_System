...
export const stationBookingService = { list: async (id: string, params: Record<string, unknown>) => unwrapData<StationBookingPage>(await apiClient.get(`${root(id)}/bookings`, { params })) };
