          ...
          <section className={`rounded-3xl border bg-white p-6 md:p-8 dark:bg-slate-900 transition-colors shadow-sm ${
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-start justify-between gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-4 md:mt-0">
                <Link to={`/app/battery-health/history?vehicleId=${selected?.id}`}>
                  <Button variant="outline" className="w-full sm:w-auto rounded-xl font-semibold shadow-sm hover:shadow-md transition-all">
