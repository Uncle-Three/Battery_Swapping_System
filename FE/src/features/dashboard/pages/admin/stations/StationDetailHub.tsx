...
import { AlertCircle, ArrowLeft, Battery, BookOpen, CalendarClock, ClipboardList, Edit3, FileClock, Gauge, Loader2, Power, PowerOff, ShieldAlert, Users } from 'lucide-react';
...
const tabs = [
  ['Tổng quan', 'overview', Gauge], ['Khoang & Lịch thay pin', 'bays-slots', CalendarClock], ['Kho pin thay thế', 'inventory', Battery],
  ['Lịch đặt chỗ', 'bookings', BookOpen], ['Nhân sự & Phân công', 'staff', Users], ['Bảo trì & Sự cố', 'maintenance', ShieldAlert],
  ['Báo cáo', 'reports', ClipboardList], ['Nhật ký hệ thống', 'audit-logs', FileClock],
] as const;
